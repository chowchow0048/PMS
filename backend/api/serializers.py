...
from core.models import Student, Subject, Time, Clinic, Comment, StudentPlacement
...
class ClinicSerializer(serializers.ModelSerializer):
    ...
    time_display = serializers.CharField(source="clinic_time.__str__", read_only=True)
